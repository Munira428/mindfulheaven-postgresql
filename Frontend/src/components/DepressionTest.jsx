            ...
            <div className='flex flex-col justify-center items-center h-[65vh] box-border'>
                <div className='rounded-xl flex flex-col justify-center items-center p-8 gap-6 bg-[#eae0e0] max-[433px]:h-[50vh]'>
                    ...
                    <div className='flex flex-col justify-center items-center'>
                        <h1 className='text-xl font-bold text-center my-2 max-[433px]:text-sm'>Take the test with the following in mind</h1>
                        <p className='text-lg max-[433px]:text-sm text-center'>Over the last 2 weeks, how often you bothered by each problems in questions?
                        </p>
                    </div>
                    <Link 
